...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Gönderi Ekle</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
  ...
  <div class="col-lg-10 col-lg-offset-1">
    <?php echo form_open_multipart('',array('class'=>'form-horizontal'));?>
      <div class="form-group">
        ...
        <?php echo form_input('post_header','','class="form-control"');?>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <?php echo form_input('post_meta_keywords','','class="form-control"');?>
      </div>
      <div class="form-group">
        <?php echo form_label('Meta Açıklama','post_meta_description');?>
        <?php echo form_error('post_meta_description');?>
        <?php echo form_input('post_meta_description','','class="form-control"');?>
      </div>
      <div class="form-group">
        <?php echo form_label('Kategori','post_category_id');?>
        <?php echo form_error('post_category_id');?>
        <?php echo form_dropdown( 'post_category_id', $categories); ?>
        <?php echo form_hidden( array('post_user_id' => $this->ion_auth->get_user_id() ) ); ?>
      </div>
      <?php echo form_submit('submit', 'Gönderiyi Ekle', 'class="btn btn-primary btn-lg btn-block"');?>
    <?php echo form_close();?>
  </div>
</div>
