...
class Users extends Admin_Controller
{
  ...
  {
    $this->data['page_title'] = 'Kullanıcılar - Yönetim Paneli';
  ...
  {
    $this->data['page_title'] = 'Kullanıcı Ekle - Yönetim Paneli';
  ...
  public function edit($user_id = NULL)
  {
    ...
    $this->data['page_title'] = 'Kullanıcı Güncelle - Yönetim Paneli';
    $this->load->library('form_validation');
